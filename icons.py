...
def main(icon_spec):
    ...
    def filter_changed(value):
        proxy_model.setFilterRegularExpression(value)
        table_view.resizeRowsToContents()
    filter_line_edit = QLineEdit()
    filter_line_edit.setMaximumWidth(200)
    filter_line_edit.setPlaceholderText('Filter name')
    filter_line_edit.setToolTip('Filter name optionally using regular expressions (' + QKeySequence(QKeySequence.StandardKey.Find).toString() + ')')
    ...
    signal_mapper.mappedInt.connect(action_toggled)
